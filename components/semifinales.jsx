...
export default async function Cuartos() {
  ...
  return (
    <div className="mt-10 p-3 xl:max-w-6xl md:max-w-5xl xl:mx-auto">
      ...
      <ul className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 gap-4 items-center mb-2">
        {semifinales.map((partido, index) => (
          <li key={index} className="flex flex-col items-center bg-background rounded-xl border border-cyan-300 p-4">
            {/* Desktop View */}
            <div className="hidden lg:grid lg:grid-cols-[1fr_1fr_1fr] gap-4 w-full">
              ...
              <div className="flex flex-col items-center justify-center">
                ...
                <p className="text-xs text-center">{partido.estadio}</p>
              </div>
              <div className="w-full flex flex-col items-center gap-3">
                <Image
                  alt={partido.pais2}
